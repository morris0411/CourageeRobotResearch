...
しかし、恐れ、ためらい、動機間の葛藤は内的な過程であり、人間をモデルとした場合、これらを直接観察し、体系的に操作することは難しい。ロボットであれば、条件間で外見や操作対象以外の顕在的行動を比較的一定に保ちながら、ロボットに帰属される行動前の動機の表現を提示できるため、統制された社会的モデルとなりうる。本研究の主な目的は、価値ある行動へ向かう動機と、そのリスクを避ける動機の併存として定義される、ロボットによる接近回避葛藤の表現がどのように知覚され、観察者の個人的勇気に関する即時的な自己評価とどのように関連するかを検討することであった。すなわち、本研究では、観察しにくい行動前の動機の表現を観察・統制可能にする方法論的手段であると同時に、その表現が利用者によって異なる反応と関連しうるHRI刺激としてロボットを用いた。
...
これらの研究は、ロボットと人工エージェントが観察者に影響を与える社会的モデルとして機能しうることを示している。しかし、ここで概観した研究が対象としたのは、態度、自己効力感、運動、励まし行動であり、個人的勇気そのものではない。本稿で検討した文献の範囲では、行動前にモデルが経験する恐れや葛藤を表現し、その表現の観察が観察者の個人的勇気の自己評価とどのように関連するかを検討した報告は限られている。したがって、ロボットを用いて個人的勇気に関わる行動前の動機を観察可能な形で表現することは、既存のモデリング研究を拡張する。
...
本稿で取り上げたロボットの社会的モデリング研究では、行動や社会的役割、励まし方など、観察可能な振る舞いが観察者に及ぼす影響が検討されてきた（Xu, 2023; Higashino et al., 2023）。これに対して本研究では、ロボットを、行動前の接近動機と回避動機を統制された形で表現する社会的モデルとして用いた。研究1の操作チェックでは、吹き出しによる両動機の提示が接近回避葛藤として知覚されることが確認された。これは、注意や心的焦点の表現に用いられてきた吹き出し表現（Nitada et al., 2021）を、相反する動機の表現へ拡張するものである。また、研究1では、ロボットの外観と最終行動をそろえながら動機表現を操作することにより、人間モデルでは直接観察・統制しにくい行動前の手がかりを条件間で比較できた。したがって、本研究の貢献は、他の提示媒体に対するロボットの優位性を示したことではなく、ヒューマンロボットインタラクション研究において、行動前の動機表現を統制して提示する実験方法を示した点にある。

二つの研究を合わせると、ロボットによる行動前の動機表現については、ロボット自身がどのように知覚されるかと、その観察が利用者にどのような影響を及ぼすかを分けて考える必要がある。研究1では葛藤表出によってロボットの勇気評定が高くなった。研究2では、予測した3要因交互作用は支持されなかった一方、事前勇気傾向群×葛藤表現の予想外の交互作用において、葛藤条件差が二群で反対方向を示した。さらに、同時提示はロボットをより葛藤しているように見せたが、葛藤あり条件だけでなく葛藤なし条件の評定も高めた。そのため、葛藤の印象を強めることと、葛藤あり・なしの違いを明確に伝えることは別である。したがって、このような表現を設計する際には、意図した動機構造がどの程度強く知覚されるか、他の構造と区別して伝えられるか、利用者にどのような影響を与えるかを、それぞれ評価する必要がある。また、同じ葛藤表出がすべての利用者に同じ結果をもたらすとは限らないため、利用者の事前特性に応じた表現設計も今後の検討課題となる。ただし、低勇気群の結果は有意傾向であり、実際の行動も測定していないため、個別適応型表現の有効性が本研究によって確認されたわけではない。

## 限界

本研究にはいくつかの限界がある。第一に、本研究では観察者の個人的勇気の自己評価を測定したが、観察者が実際に価値ある行動へ向かったかは測定していない。CM-Jは、恐怖や不安があっても行動する勇気の特性的な個人差を測定する（Shimotsukasa et al., 2023）。したがって、本研究における刺激提示後のCM-J得点は、長期的な勇気特性の変化ではなく、刺激提示直後における観察者の個人的勇気の自己評価として解釈すべきである。さらに、刺激提示前のCM-Jは4本すべての動画を提示する前に1回だけ測定されたため、条件固有のbaselineではなく全条件に共通するbaselineであった。このデザインでは、各刺激に固有のpreからpostへの変化を切り分けることはできない。したがって、研究2の結果が示すのは、ロボット表現の各条件後に得られた勇気自己評価の相対的な差であり、葛藤表出の観察によってbaselineから個人的勇気の自己評価がstate-likeに上昇したことの証拠として解釈すべきではない。

第二に、研究1の操作チェックから確認できたのは、提示した動機構造が参加者に葛藤として知覚されたことであり、ロボットの内的状態そのものを直接操作したことではない。さらに、同時提示は葛藤あり条件だけでなく葛藤なし条件でも葛藤評定を高めた。したがって、得られた印象には、接近動機と回避動機の併存だけでなく、ためらいや葛藤を一般的に想起させる提示形式そのものが寄与した可能性がある。本研究の結果は、ロボットが葛藤を有していた、あるいは経験していたことの証拠ではなく、設計された葛藤表現に対する反応として解釈すべきである。

第三に、H2の根拠は、課題特異的な対処モデルおよび自己効力感に関する知見を、観察者の個人的勇気の自己評価へ拡張したものであった。両者を結ぶと想定したのは、困難を示した後に行動するモデルの観察が、勇気ある意思決定に関係する行動可能性の評価に影響するという経路である。しかし、本研究では、行動可能性の評価、自己効力感、モデルと観察者との類似性、ロボットが対処モデルとして認知されたか、あるいはためらいやリスク情報がどのように解釈されたかを測定していない。したがって、H2で想定した経路を直接検証することも、事前勇気傾向群と葛藤との予想外の交互作用を生じさせた心理過程を特定することもできない。

第四に、本研究ではロボットを用いた動画刺激のみを使用し、実物のロボット、人間モデル、アバター、アニメーション、文章提示など、他の提示媒体との比較を行っていない。したがって、本研究の結果が、非人間エージェントとしてのロボット、動画という形式、あるいは吹き出しによる接近回避葛藤の明示的提示のいずれに起因するかを判断することはできない。

第五に、本研究の刺激場面は、ロボットが公園でポイ捨てをした人物に注意する場面に限られていた。この場面は価値ある行動と対人的リスクが併存するため、個人的勇気を検討する刺激として一定の妥当性を持つ。しかし、本研究で検討したのは、ロボットが見知らぬ人物による規範違反を直接注意する場面であった。個人的勇気には、対人場面での発言、援助要請、学習課題への挑戦、社会復帰、向社会的行動など、多様な状況が含まれうる（Pury et al., 2007; Vogel et al., 2007; Howard et al., 2017）。したがって、本研究の知見が、異なる種類のリスクや行動価値を含む状況に一般化できるかは明らかでない。
