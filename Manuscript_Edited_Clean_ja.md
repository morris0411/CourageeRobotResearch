...
勇気とは、恐れやためらい、相反する動機が存在するにもかかわらず、価値ある行動を追求することに関わる。しかし、ある行為を勇気あるものと判断するうえで重要な行動前の葛藤は、人間をモデルとする場合、直接観察し、体系的に操作することが難しい。ロボットは、このような通常は観察できない動機を、統制された再現可能な形で表現するための手段となる。そこで本研究では、ロボットによる接近回避葛藤の表現がどのように知覚され、観察者自身の個人的勇気に関する即時的な自己評価とどのように関連するかを検討した。公園でポイ捨てをする人物にロボットが遭遇する場面を用い、円筒形ロボットの頭部付近に吹き出しを投影して、接近動機と回避動機を提示した。研究1では、葛藤あり条件と葛藤なし条件、および逐次提示と同時提示を比較し、接近回避葛藤を表出するロボットが勇気ある姿として知覚されるかを検討した。研究2では、ロボットが一方向の動機のみを表出するか、接近・回避の両動機を表出するか、またポイ捨てをした人物に注意するかを操作し、刺激提示後の勇気の自己評価が観察者の事前勇気傾向によって異なるかを検討した。研究1では、葛藤あり条件の勇気評定と葛藤評定が葛藤なし条件より高かった。研究2では、予測した3要因交互作用は支持されなかった。一方、主要仮説では予測していなかった事前勇気傾向群×葛藤表現の有意な2要因交互作用が認められた。低勇気群では葛藤あり条件で自己評価が高くなる有意傾向が認められた一方、高勇気群では葛藤あり条件において自己評価が有意に低かった。注意行動による明確な効果は認められなかった。この対照的なパターンは、ロボットの葛藤表現の受け取られ方が、観察者の事前勇気傾向によって異なる可能性を示している。本研究は、ロボットが表出する動機がどのように知覚されるかを検討するための統制されたHRI研究パラダイムを提示し、内的過程を示す手がかりを提示するロボットの設計において利用者特性を考慮する重要性を示している。
...
この過程を支援する一つの方法として、本研究は観察学習に着目する。観察学習では、他者の行動や成功を観察することで、自分自身が行動できる可能性についての期待が変化しうる（Bandura, 1977）。先行研究では、モデル観察後に外から観察可能な運動成績が変化すること（Weiss et al., 1998）に加え、行動観察中に運動関連の神経活動が生じること（Chaisaen et al., 2020）が示されている。観察学習はさらに、自己効力感や持続性などの心理過程にも影響しうる（Schunk and Hanson, 1985; Leonard et al., 2017）。自己効力感と個人的勇気は異なる構成概念である。自己効力感は、ある行動を遂行できるという自身の能力に関する信念を指すのに対し、個人的勇気は、恐れやリスクがあっても価値ある行動へ向かうことに関わる。しかし、勇気の過程モデルでは、行動を決定する前に行動可能性を評価する過程が含まれている（Chowkase et al., 2024）。したがって、困難を示した後に行動するモデルの観察は、「困難があっても行動は可能である」という代理的情報を与える可能性がある。本研究ではこれを、自己効力感への効果がそのまま勇気に一般化する直接的証拠ではなく、観察学習と個人的勇気の即時的な自己評価を結ぶ候補的な仕組みとして位置づける。

しかし、恐れ、ためらい、動機間の葛藤は内的な過程であり、人間をモデルとした場合、これらを直接観察し、体系的に操作することは難しい。ロボットであれば、条件間で外見や操作対象以外の顕在的行動を比較的一定に保ちながら、ロボットに帰属される行動前の動機の表現を提示できるため、そのような動機表現に対する観察者反応を検討するための統制されたHRI刺激となりうる。本研究の主な目的は、価値ある行動へ向かう動機と、そのリスクを避ける動機の併存として定義される、ロボットによる接近回避葛藤の表現がどのように知覚され、観察者の個人的勇気に関する即時的な自己評価とどのように関連するかを検討することであった。すなわち、本研究では、観察しにくい行動前の動機の表現を観察・統制可能にする方法論的手段であると同時に、その表現が利用者によって異なる反応と関連しうるHRI刺激としてロボットを用いた。

本研究では、異なる役割を持つ二つの研究を実施した。研究1のH1では、接近動機と回避動機の両方を提示する葛藤あり条件は、接近動機のみを提示する葛藤なし条件より、ロボットの勇気評定が高くなると予測した。また、接近動機と回避動機の併存が葛藤として知覚されたかを、操作チェックとして検討した。逐次提示と同時提示の比較は探索的検討と位置づけ、研究2で使用する提示方法の選定に用いた。研究2のH2では、事前勇気傾向、表出された葛藤、最終的な行動の3要因交互作用を予測した。具体的には、低勇気群内の4条件のうち、葛藤あり・行動あり条件で自己評価得点が最も高くなると予測した。二つの研究では、ロボットがどのように知覚されるかと、その表現が観察者の反応とどのように関連するかを区別して検討する。これにより、本研究を、個人的勇気を心理学的文脈として、行動前の動機手がかりに対する反応が利用者間でどのように異なるかを検討する、ロボット表現設計に関する基礎的HRI研究として位置づける。
...
観察学習におけるモデルは人間に限られない。人工エージェントやアバターを用いた研究では、視覚的に存在するエージェントや自己に似たアバターが、観察者の態度、自己効力感、その後の行動に影響しうることが示されている（Rosenberg-Kima et al., 2008; Fox and Bailenson, 2009）。社会的ロボットに関する研究でも、人がロボットを社会的モデルとして扱い、その行動結果や社会的役割に基づいてモデリングを行いうることが示されている（Xu, 2023）。さらに、ロボットによる励まし方が、その後に参加者が他者を励ます方法に影響することも明らかにされている（Higashino et al., 2023）。比較的限定されたロボットの行動であっても、課題への取り組みに影響しうる。Ishikawa et al.（2026）は、社会的ロボットと人間のいずれによる経過時間の言語的通知も、通知なし条件と比べて、困難な課題に対する幼児の持続性を高めたことを報告している。この結果は、ロボットの影響が一般的に人間の影響と同等であることを示すものではないが、統制されたロボットの行動が利用者に測定可能な影響を与えうることを示している。

これらの研究は、ロボットと人工エージェントが観察者に影響を与える社会的モデルとして機能しうることを示している。しかし、ここで概観した研究が対象としたのは、態度、自己効力感、運動、励まし行動であり、個人的勇気そのものではない。本稿で検討した文献の範囲では、行動前にモデルが経験する恐れや葛藤を表現し、その表現の観察が観察者の個人的勇気の自己評価とどのように関連するかを検討した報告は限られている。したがって、ロボットを用いて個人的勇気に関わる行動前の動機を表現することは、そのようなロボットが社会的モデルとして機能しうるかを検討するための基礎となる。

### ロボットによる内的状態の表現

観察しにくい行動前の過程がもたらす社会的影響を研究するうえで、ロボットには二つの方法論的利点がある。第一に、ロボットの外見、行動、発話、タイミングを実験条件間で一貫して再現できるため、提示間に生じる意図しない変動を抑えることができる。第二に、ロボットに帰属される状態の表現を視覚的・言語的に明示できるため、提示する動機構造をロボットの外的な行動とは別に操作できる。もっとも、このような利点はロボットだけに固有のものではなく、人間の演者、アバター、テキストベースのエージェントによって内的状態の表現を提示することも可能である。それでもロボットは、その表現や行動が利用者に影響を与えうる身体性を持った社会的エージェントであるため、HRI研究において特に重要である。そこで本研究では、ロボットの動作と発話に加えて吹き出し表現を使用し、ロボットに帰属される接近動機と回避動機を、統制された直接観察可能な形で提示した。
...
以上より、先行研究は、個人的勇気が恐れや困難を伴う行動を含むこと、観察学習が自己効力感や知覚された行動可能性に影響しうること、ロボットと人工エージェントが社会的モデルとして機能しうることを示してきた。しかし、本稿で検討した文献の範囲では、個人的勇気に関わる行動前の動機、とりわけ接近動機と回避動機との葛藤をロボットによって表現し、その観察が観察者の個人的勇気の自己評価とどのように関連するかは十分に検討されていない。本研究は、この未検討の問題に着目し、接近回避葛藤を表出するロボットの観察が、観察者の個人的勇気の自己評価とどのように関連するかを検討する。

## 動画刺激の設計

### ロボットと投影環境

本研究で使用したロボットは、Omichi et al.（2026）が提案したswitch-based robot interfaceと同一の筐体設計を有していた。このロボットは円筒形の本体を持ち、非発話時には顔を持つエージェントが本体内部に格納され、発話時にはエージェントが本体上部から現れる構造であった（Omichi et al., 2026）。両研究で使用したロボットの非発話時および発話時の外観を図1に示す。本研究では、吹き出しを用いた行動前の動機表現が、観察者の個人的勇気の自己評価とどのように関連するかを検討したため、ロボットの外見や身体動作から生じる解釈のばらつきを最小限に抑える必要があった。このロボットは、人型ロボットのような複雑な表情や四肢の動きを持たず、主な表出手段は表示される顔と発話である。この設計により、接近動機、回避動機、注意発話の有無を比較的統制された形で提示する刺激媒体として適していた。注意発話には事前に録音した音声を使用し、実験者がキーボード入力によって再生した。

動画刺激では、ロボットが画面右下に映るよう撮影し、ロボットに帰属される行動前の動機を、ロボットの背後の壁面に投影した吹き出しとして表示した。吹き出しはロボットの頭部付近に配置し、ロボットの発話内容ではなく、帰属された動機を表す視覚表現として使用した。
...
この共通設計を適用することにより、行動前の動機の表現を、観察者が視覚的に解釈できる形で提示した。各研究における条件操作の詳細は、それぞれの方法節で述べる。

## 研究1：接近回避葛藤を表出するロボットは勇気ある姿として知覚されるか

### 目的

研究1では、研究2で使用する予定の提示が、勇気ある姿として知覚されるかを検討した。具体的には、帰属される動機によって接近回避葛藤を表出するロボットが、葛藤を表出しないロボットよりも勇気ある姿として知覚されるかを検討した。また、提示した動機が接近回避葛藤として知覚されたかを葛藤評定によって確認するとともに、逐次提示と同時提示が勇気評定および葛藤評定に及ぼす影響を探索的に比較した。
...
この考えに基づき、葛藤あり条件では葛藤なし条件よりもロボットの勇気評定が高くなると予測した（H1）。また、操作チェックとして、葛藤あり条件では葛藤なし条件よりも葛藤評定が高くなると予測した。逐次提示と同時提示との比較は探索的に行い、どちらの方法がより勇気ある姿として知覚されるかを検討した。
...
研究1は、Yahoo!クラウドソーシングを通じて実施した。参加者は4条件の動画を視聴し、各動画の視聴後にロボットの勇気評定項目と葛藤評定項目に回答した。動画の提示順は参加者ごとにランダム化した。質問紙では、過去の同一調査への参加歴も尋ねた。注意深く回答していたかを確認するため、Directed Questions Scale（DQS; Maniaci and Rogge, 2014）の指示回答形式を用いた。この形式では、指定された選択肢への回答を求めた。また、場面ならびにロボットが表示した思考と行動の理解を確認するため、3択単一回答式の動画内容理解確認4項目を用いた。過去の同一調査への参加、確認項目の未回答、指示された選択肢への不正答、または動画内容理解確認4項目すべてへの正答を求める基準を満たさなかった場合を除外基準とした。
...
計211件の回答記録が得られた。このうち、確認項目に欠測があった26件を除外した。残る185件のうち、過去に同一調査へ参加したと回答した20件、DQS形式の指示回答式チェックに不正答だった29件、または動画内容理解確認4項目すべてへの正答を求める基準を満たさなかった28件（少なくとも1項目に誤答）のいずれかに該当する54件を除外した（基準間の重複あり）。以上により計80件を除外し、最終的な分析対象者は131名となった。
...
研究1では、接近回避葛藤を表出するロボットが、葛藤なし条件のロボットよりも勇気ある姿として評定され、H1は支持された。この結果は、顕在的な行動が同じであっても、行動前に接近動機と回避動機との葛藤を示すことで、その行動が行為者にとって恐怖や困難を伴うものとして解釈されやすくなることを示している。この解釈は、個人的勇気の高い行動には恐怖や困難が伴うとする見解と整合する（Pury et al., 2007）。したがって、ロボットに帰属される行動前の動機を提示することは、観察者がその行動を勇気あるものとして解釈することを促す可能性がある。
...
研究2は、SurveyMonkeyを使用し、Yahoo!クラウドソーシングを通じて実施した。参加者はまず、刺激提示前にCM-Jに回答した。その後、四つの刺激－回答ブロックを参加者ごとにランダムな順序で提示した。各ブロックは一つの動画と、それに続く観察者自身の個人的勇気の自己評価項目およびロボットの葛藤評定項目から構成された。質問紙では、過去の同一調査への参加歴も尋ねた。注意深く回答していたかを確認するため、DQSの指示回答形式を用いた。また、各動画で提示された条件固有の内容を認識していたかを確認するため、各動画後に3択単一回答式の動画内容理解確認を実施した。過去の同一調査への参加、確認項目の未回答、指示された選択肢への不正答、または動画内容理解確認4項目すべてへの正答を求める基準を満たさなかった場合を除外基準とした。
...
欠測および除外を見込み、212名を募集した。このうち未完了の13名を除外した。残る199名のうち、過去に同一調査へ参加したと回答した19名、DQS形式の指示回答式チェックに不正答だった31名、または動画内容理解確認4項目すべてへの正答を求める基準を満たさなかった53名（少なくとも1項目に誤答）のいずれかに該当する73名を除外した（基準間の重複あり）。以上により計86名を除外し、最終的な分析対象者は126名となった。
...
しかし、H2では予測していなかった事前勇気傾向群と接近回避葛藤との有意な交互作用が認められ、葛藤あり条件と葛藤なし条件との差が群によって異なることが示された。低勇気群では、葛藤あり条件で自己評価が高くなる有意傾向が認められた。重要な点として、この交互作用がロボットの行動の有無によって異なることを示す3要因交互作用は有意ではなかったため、葛藤の後に行動することを前提としたH2の対処モデル経路を支持するものではない。むしろ、この結果はH2とは異なる可能性を示している。すなわち、行動結果ではなく葛藤表出そのものが、観察者の事前勇気傾向に応じて、刺激直後の勇気の自己評価と異なる形で関連した可能性がある。低勇気群にとっては、接近動機と回避動機が併存しうることが明示されたことで、ためらいと価値ある行動へ向かうことが両立可能なものとして受け取られ、より自己関連性の高い情報になった可能性がある。この群差を生じさせた心理過程については、今後の検証が必要である。

一方、高勇気群では、葛藤あり条件の個人的勇気自己評価得点が有意に低かった。Chowkaseら（2024）は、勇気ある決定では、価値ある結果と行動に伴うリスクとが比較されると理論化している。また、Bachら（2014）は、接近回避課題において、潜在的脅威が高まるほど回避行動と行動抑制が増えることを示した。本研究の葛藤あり条件では、注意することの価値を示す接近動機と、「怒鳴られる」「無視される」といったリスクを示す回避動機とが同時に提示された。そのため高勇気群では、行動の価値だけでなく、それに伴うリスクも改めて検討することになり、自身の勇気をより慎重に評価した可能性がある。ただし、これらの先行研究は、高勇気群において他者の葛藤を観察した後に自己評価が低下することを直接示したものではなく、今回の結果を説明する一般的な機序の候補を与えるにとどまる。

以上をまとめると、この2要因交互作用では、低勇気群における正方向の有意傾向と、高勇気群における有意な負方向の差という、対照的な方向が認められた。これはH2で予測した行動に依存するパターンではなく、当初の仮説を支持するものではない。しかし、この結果は、同じロボットの葛藤表出であっても、観察者の事前勇気傾向によって自己評価と異なる方向に関連する可能性を示している。また、操作チェックでは葛藤あり条件の葛藤評定が高く、意図した葛藤表出は参加者に知覚されていた。

## 総合考察

本稿で取り上げたロボットの社会的モデリング研究では、行動や社会的役割、励まし方など、観察可能な振る舞いが観察者に及ぼす影響が検討されてきた（Xu, 2023; Higashino et al., 2023）。これに対して本研究では、そのようなロボットが社会的モデルとして機能しうるかを検討するための基礎的段階として、ロボットを用いて行動前の接近動機と回避動機を統制された形で表現した。研究1の操作チェックでは、吹き出しによる両動機の提示が接近回避葛藤として知覚されることが確認された。これは、注意や心的焦点の表現に用いられてきた吹き出し表現（Nitada et al., 2021）を、相反する動機の表現へ拡張するものである。また、研究1では、ロボットの外観と最終行動をそろえながら動機表現を操作することにより、人間モデルでは直接観察・統制しにくい行動前の手がかりを条件間で比較できた。したがって、本研究の貢献は、他の提示媒体に対するロボットの優位性を示したことではなく、ヒューマンロボットインタラクション研究において、行動前の動機表現を統制して提示する実験方法を示した点にある。

二つの研究を合わせると、ロボットによる行動前の動機表現については、ロボット自身がどのように知覚されるかと、ロボットを観察した後に利用者がどのように反応するかを分けて考える必要がある。研究1では葛藤表出によってロボットの勇気評定が高くなった。研究2では、予測した3要因交互作用は支持されなかった一方、事前勇気傾向群×葛藤表現の予想外の交互作用において、葛藤条件差が二群で反対方向を示した。さらに、同時提示はロボットをより葛藤しているように見せたが、葛藤あり条件だけでなく葛藤なし条件の評定も高めた。そのため、葛藤の印象を強めることと、葛藤あり・なしの違いを明確に伝えることは別である。したがって、このような表現を設計する際には、意図した動機構造がどの程度強く知覚されるか、他の構造と区別して伝えられるか、その表現の観察後に利用者がどのように反応するかを、それぞれ評価する必要がある。また、同じ葛藤表出がすべての利用者に同じ結果をもたらすとは限らないため、利用者の事前特性に応じた表現設計も今後の検討課題となる。ただし、低勇気群の結果は有意傾向であり、実際の行動も測定していないため、個別適応型表現の有効性が本研究によって確認されたわけではない。

## 限界

本研究にはいくつかの限界がある。第一に、本研究では観察者の個人的勇気の自己評価を測定したが、観察者が実際に価値ある行動へ向かったかは測定していない。また、CM-Jは元来、勇気の特性的な個人差を測定する尺度として開発・妥当性検証がなされたものであり（Shimotsukasa et al., 2023）、短時間の実験刺激提示に伴う即時的・状態的な変化を捉える尺度としての構成概念妥当性や測定感度が確立されているわけではない。したがって、刺激提示後のCM-J得点は、妥当性が確認された状態変化や持続的な勇気特性の変化ではなく、一時的な自己評価の表れとして慎重に解釈すべきである。さらに、刺激提示前のCM-Jは4本すべての動画を提示する前に1回だけ測定されたため、条件固有のbaselineではなく全条件に共通するbaselineであった。このデザインでは、各刺激に固有のpreからpostへの変化を切り分けることはできない。したがって、研究2の結果が示すのは、ロボット表現の各条件後に得られた勇気自己評価の相対的な差であり、葛藤表出の観察によってbaselineから個人的勇気の自己評価がstate-likeに上昇したことの証拠として解釈すべきではない。

第二に、研究2の要因計画では、葛藤なし条件において動機の価数（方向性）と最終的な行動結果との間に交絡が存在する。具体的には、動機の内容を行動結果と整合させるため、行動あり条件では接近動機のみを、行動なし条件では回避動機のみを提示した。その結果、葛藤なし条件における行動の有無の対比は、提示された動機の価数（接近か回避か）の違いを同時に含んでいる。この設計は表出された思考と後続行動との自然な整合性を保つためのものであったが、葛藤要因と行動要因を、動機の有無と行動実行とを完全に直交させた独立した操作として解釈することには限界がある。

第三に、研究1の操作チェックから確認できたのは、提示した動機構造が参加者に葛藤として知覚されたことであり、ロボットの内的状態そのものを直接操作したことではない。さらに、同時提示は葛藤あり条件だけでなく葛藤なし条件でも葛藤評定を高めた。したがって、得られた印象には、接近動機と回避動機の併存だけでなく、ためらいや葛藤を一般的に想起させる提示形式そのものが寄与した可能性がある。本研究の結果は、ロボットが葛藤を有していた、あるいは経験していたことの証拠ではなく、設計された葛藤表現に対する反応として解釈すべきである。

第四に、H2の根拠は、課題特異的な対処モデルおよび自己効力感に関する知見を、観察者の個人的勇気の自己評価へ拡張したものであった。両者を結ぶと想定したのは、困難を示した後に行動するモデルの観察が、勇気ある意思決定に関係する行動可能性の評価に影響するという経路である。しかし、本研究では、行動可能性の評価、自己効力感、モデルと観察者との類似性、研究2の各条件におけるロボットが勇気あるものとして知覚されたか、または観察者自身に関連する社会的モデルとして捉えられたか、さらに、ためらいやリスク情報がどのように解釈されたかを測定していない。したがって、本研究から社会的モデリングが生じたと結論づけることはできず、H2で想定した経路を直接検証することも、事前勇気傾向群と葛藤との予想外の交互作用を生じさせた心理過程を特定することもできない。

第五に、本研究ではロボットを用いた動画刺激のみを使用し、実物のロボット、人間モデル、アバター、アニメーション、文章提示など、他の提示媒体との比較を行っていない。したがって、本研究の結果が、非人間エージェントとしてのロボット、動画という形式、あるいは吹き出しによる接近回避葛藤の明示的提示のいずれに起因するかを判断することはできない。

第六に、本研究の刺激場面は、ロボットが公園でポイ捨てをした人物に注意する場面に限られていた。この場面は価値ある行動と対人的リスクが併存するため、個人的勇気を検討する刺激として一定の妥当性を持つ。しかし、本研究で検討したのは、ロボットが見知らぬ人物による規範違反を直接注意する場面であった。個人的勇気には、対人場面での発言、援助要請、学習課題への挑戦、社会復帰、向社会的行動など、多様な状況が含まれうる（Pury et al., 2007; Vogel et al., 2007; Howard et al., 2017）。したがって、本研究の知見が、異なる種類のリスクや行動価値を含む状況に一般化できるかは明らかでない。

## 今後の研究

今後の研究は、基礎的アプローチと応用的アプローチという二つの方向で進める必要がある。基礎研究では、接近回避葛藤の提示が観察者の個人的勇気の自己評価に影響する心理過程を検討すべきである。具体的には、観察者がロボットを自己に関係するモデルまたは困難に対処するモデルとしてどの程度知覚したか、ロボットとの類似性、知覚された行動可能性、自己効力感、知覚された脅威と困難さ、行動情報の付加価値を測定する必要がある。また、事前勇気傾向と接近回避葛藤との交互作用が生じる条件も明らかにする必要がある。行動前の動機を表現する方法については、同時提示と逐次提示、強調の程度、提示タイミングなどを操作し、意図した動機構造がどの程度強く知覚されるかだけでなく、他の構造から正しく区別されるかも検討する必要がある。さらに、同一の場面と動機表現を使用し、物理的に存在するロボット、動画で提示されるロボット、人間モデル、アバターまたはアニメーション、文章のみの提示を比較すべきである。この比較によって、非人間のロボットが社会的モデルとして機能する条件、および身体性、共在性、動きが果たす役割を明らかにできる。
...
本研究は、ロボットによる行動前の接近回避葛藤の表現が、ロボットの勇気知覚と観察者の個人的勇気の自己評価にどのように関係するかを検討した。研究1では、葛藤を表出するロボットの勇気評定が高かった。研究2では、予測した3要因交互作用は支持されなかった一方、事前勇気傾向群×葛藤表現の予想外の交互作用において、低勇気群では正方向の有意傾向、高勇気群では有意な負方向の差が認められた。本研究は、観察しにくい行動前の動機を表現するロボットが社会的モデルとして機能しうるかを検討するための統制されたHRIパラダイムを提示するとともに、同じ表現であっても利用者によって異なる反応と関連する可能性を示唆する。ただし、ロボット固有の効果や実際の勇気ある行動の変化は示しておらず、今後は他の提示媒体との比較と、個別適応型表現が実際の行動に及ぼす影響を検証する必要がある。

## 利益相反声明

著者らは、本研究がダイキン工業株式会社から資金提供を受けたことを申告する。資金提供者は、研究計画、データの収集・分析・解釈、本論文の執筆、または投稿の決定には関与していない。
...
| 研究1の条件 | 提示した動機構造 | 使用した動機文 | 提示方法 | 最後の注意発話 |
| --- | --- | --- | --- | --- |
...
| 研究2の条件 | 提示した動機構造 | 使用した動機文 | 提示方法 | 最後の注意発話 |
| --- | --- | --- | --- | --- |
