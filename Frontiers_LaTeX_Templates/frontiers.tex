...
The three-way mixed analysis of variance on observers' personal courage self-evaluation scores revealed a significant main effect of pre-existing courage tendency group (F(1, 124) = 124.884, p \textless{} .001, partial eta squared = .502). By contrast, neither the main effect of conflict (F(1, 124) = 0.067, p = .796, partial eta squared \textless{} .001) nor the main effect of action (F(1, 124) = 2.487, p = .117, partial eta squared = .020) was significant. Among the two-way interactions, the interaction between pre-existing courage tendency group and conflict was significant (F(1, 124) = 7.513, p = .007, partial eta squared = .057). By contrast, neither the interaction between pre-existing courage tendency group and action (F(1, 124) = 0.009, p = .925, partial eta squared \textless{} .001) nor the interaction between conflict and action (F(1, 124) = 2.613, p = .109, partial eta squared = .021) was significant. The primary three-way interaction was also not significant (F(1, 124) = 0.046, p = .831, partial eta squared \textless{} .001). Thus, the hypothesis that personal courage self-evaluation scores would be particularly high in the conflict-with-action condition among the low-courage group was not supported.

Because the interaction between pre-existing courage tendency group and conflict was significant, we examined the simple effect of conflict within each group. Shapiro-Wilk tests of the paired difference scores indicated no significant departure from normality in the low-courage group (W = 0.974, p = .152) but indicated a significant departure in the high-courage group (W = 0.928, p = .002). Accordingly, a paired t-test was used for the low-courage group, whereas a Wilcoxon signed-rank test was used for the high-courage group. The simple-effects analyses showed a marginal trend toward higher personal courage self-evaluation scores in the conflict condition in the low-courage group (conflict M = 3.104, no conflict M = 2.982, t(68) = 1.980, p = .052, d = .238). In contrast, participants in the high-courage group reported significantly lower personal courage self-evaluation scores in the conflict condition (conflict M = 4.757, no conflict M = 4.858, W = 404.0, p = .038, d = -.271). These simple effects are shown in Figure~\ref{fig:study2_courage}.
...
By contrast, participants in the high-courage group reported lower personal courage self-evaluation scores in the conflict condition. Chowkase et al. theorized that courageous decisions involve weighing potential valued outcomes against the perceived risks associated with action \citep{chowkase2024}. In an approach-avoidance task, Bach et al. experimentally showed that greater potential threat was accompanied by greater passive avoidance and behavioral inhibition \citep{bach2014}. In the present conflict condition, the robot simultaneously expressed an approach motive indicating the value of admonishing the litterer and avoidance motives indicating risks such as being yelled at or ignored. These avoidance motives may therefore have been interpreted as information about the risks of acting, leading the high-courage group to consider not only the value of the action but also its associated risks and to evaluate their own courage more cautiously. However, neither of these prior studies directly showed that observing another agent's conflict lowers self-evaluation specifically among individuals with high pre-existing courage. They therefore provide only a possible general mechanism for interpreting the present result.

Although the main effect of conflict on personal courage self-evaluation was not significant, the interaction between pre-existing courage tendency group and conflict was significant, and the direction of the conflict contrast differed between groups. The absence of a main effect should therefore not be interpreted as evidence that conflict expression was unrelated to self-evaluation in both groups. Moreover, conflict ratings were higher in the conflict condition than in the no-conflict condition, indicating that participants perceived the intended conflict expression. Thus, the unsupported hypothesis cannot be attributed solely to a failed conflict manipulation. Overall, robot-expressed conflict did not uniformly raise observers' self-evaluations; instead, its association with self-evaluation may differ in direction according to observers' pre-existing courage tendency.
