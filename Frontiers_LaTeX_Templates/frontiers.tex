...
\def\firstAuthorLast{Shimizu {et~al.}} %use et al only if is more than 1 author
...
$^{3}$Faculty of Science and Engineering, Otemon Gakuin University, Japan}
...
%%% There is no need for adding the file termination, as long as you indicate where the file is saved. In the examples below the files (logo1.pdf and logos.pdf) are in the Frontiers LaTeX folder
%%% If using *.tif files convert them to .jpg or .png
%%%  NB logo1.pdf is required in the path in order to correctly compile front page header %%%

\begin{figure}[h!]
\begin{center}
\includegraphics[width=10cm]{logo1}% This is a *.pdf file
\end{center}
