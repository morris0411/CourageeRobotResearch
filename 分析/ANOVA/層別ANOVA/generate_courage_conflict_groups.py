...
HIGH_DIR = OUTPUT_DIR / "勇気変化量_葛藤あり高群"
OTHER_DIR = OUTPUT_DIR / "勇気変化量_その他群"
...
def main() -> None:
    ...
    write_group_outputs(HIGH_DIR, "勇気尺度変化量で葛藤あり条件が両行動で高い人", high_ids, len(raw_df), long_df, selection_table)
    write_group_outputs(OTHER_DIR, "勇気尺度変化量で上記以外の人", other_ids, len(raw_df), long_df, selection_table)
